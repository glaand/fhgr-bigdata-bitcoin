...
rusty-blockparser -d mounted-data/raw-data/blocks balances mounted-data/processed-data/rusty-dump  # creates balances.csv -> address ; balance
rusty-blockparser -d mounted-data/raw-data/blocks unspentcsvdump mounted-data/processed-data/rusty-dump  # creates unspent.csv -> txid ; indexOu>
